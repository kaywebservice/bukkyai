  ...
  return (
    <div className="brief-studio">
      <div className="brief-hero">
        <h2>
          Describe your site. <span className="grad">bukkyai builds it.</span>
        </h2>
        <p>Tell us anything — a sentence is enough. Fine-tune the options below for a site that's unmistakably yours.</p>
      </div>

      <GroupCard title="1 · What are you building?" hint="The heart of it — add as much or as little as you like">
        <textarea
      ...
      <div className="brief-grid">
        <GroupCard title="2 · Features you need" hint="Pick any — or none, we'll decide">
        ...
        <div className="brief-stack">
          <GroupCard title="3 · Vibe & theme" hint="How should it feel?">
          ...
          <GroupCard title="4 · Pages" hint="Or keep it to one strong page">
          ...
          <GroupCard title="5 · Business basics" hint="Optional, but makes the copy feel real">
          ...
          <GroupCard title="6 · What should visitors do first?" hint="We'll aim every headline at this">
            <div className="brief-chips">
              {BRIEF_GOALS.map((g) => (
          ...
          <GroupCard title="7 · Voice" hint="How the site should talk">
            <div className="brief-chips">
              {BRIEF_TONES.map((t) => (
      ...
      <div className="brief-grid">
        <GroupCard title="8 · Extra touches" hint="Nice-to-haves">
      ...
      <div className="brief-actions">
        ...
        <button className="btn" onClick={onBrowseTemplates}>Start from a template</button>
        <button className="btn" onClick={onDemo}>Explore the demo</button>
        {hasSaved && (
          <button className="btn btn-ghost" onClick={restoreSaved} title="Reuse your last brief and build another version">
            ↺ Reuse last brief
          </button>
        )}
        {ready && (
